...
public class DetectorModule extends SubsystemBase {
    ...
    public List<PNPResult> solvePNP(List<TrackedNote> boundingBoxes) {
        ...
        for (TrackedNote box : boundingBoxes) {
            ...
            Point[] imagePoints = { new Point(tl.x, tl.y), new Point(br.x, tl.y), new Point(br.x, br.y),
                    new Point(tl.x, br.y) };
            List<Translation3d> modelTrls = Arrays.asList(new Translation3d(0, -0.1778, 0.1778),
                    new Translation3d(0, 0.1778, 0.1778), new Translation3d(0, 0.1778, -0.1778),
                    new Translation3d(0, -0.1778, -0.1778));
