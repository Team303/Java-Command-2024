...
public class DynamicShootSpeakerBad extends Command {
    double desiredAngle;
    ...
    // double range =
    // FieldConstants.centerSpeakOpening.getTranslation().getDistance(swerve.getPose());
    double range;
    ...
    public void initialize() {
        ...
        // - desiredTime * (curVel.vx + curAccel.ax *
        // RobotMap.Shooter.accelerationCompensationFactor);
        // double virtualGoalY = target.getY()
        // - desiredTime * (curVel.vy + curAccel.ay *
        // RobotMap.Shooter.accelerationCompensationFactor);

        // SmartDashboard.putNumber("Goal X", virtualGoalX);
        // SmartDashboard.putNumber("Goal Y", virtualGoalY);

        // Translation2d testGoalLocation = new Translation2d(virtualGoalX,
        // virtualGoalY);

        // Translation2d toTestGoal =
        // testGoalLocation.minus(swerve.getPose().getTranslation());

        // double newShotTime = shooter.interpolateTime(toTestGoal.getDistance(new
        // Translation2d()));
        ...
        // }
        // double newDist =
        // movingGoalLocation.minus(swerve.getPose().getTranslation()).getDistance(new
        // Translation2d());
    ...
    public void execute() {
        ...
        // double leftCalcVelocity =
        // shooter.calculateFlywheelSpeedLeft(desiredVelocityLeft / (2 * Math.PI *
        // 0.0508));
        // double rightCalcVelocity =
        // shooter.calculateFlywheelSpeedRight(desiredVelocityRight / (2 * Math.PI *
        // 0.0508));
    ...
    // shooter.getAbsoluteShooterAngle() - de
    // }
