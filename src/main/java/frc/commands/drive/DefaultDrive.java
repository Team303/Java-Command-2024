...
public class DefaultDrive extends Command {
    ...
    public void execute() {
        ...
        translation = new Translation2d(
                MathUtil.applyDeadband(-Robot.driverController.getLeftY(), 0.15) * DriveSubsystem.kMaxSpeed
                        * percentPower,
                MathUtil.applyDeadband(-Robot.driverController.getLeftX(), 0.15) * DriveSubsystem.kMaxSpeed
                        * percentPower);
